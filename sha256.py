...
if __name__ == '__main__':
    seed: List[int] = [
        17, 30, 0, 32, 247, 20, 162, 6, 47, 0, 31, 160, 16, 252, 180, 179,
        136, 24, 172, 113, 103, 72, 59, 104, 135, 229, 132, 209, 107, 129, 161, 171
    ]

    message: List[int] = [
        116, 61, 190, 93, 174, 15, 154, 165, 22, 242, 56, 13, 168, 8, 194, 94,
